    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                % if isProfile and 'write' in user['permissions']:
                <button type="submit" class="btn btn-danger" onclick="createProfileDisco()">Create</button>
                % endif
                
                % if not isProfile and 'write' in user['permissions']:
                <button type="submit" class="btn btn-danger" onclick="createNodeDisco()">Create</button>
                % endif
